 ...
 * Generated at: 2017-04-10 19:39:37 UTC
...
return;
    ...
    try {
      ...
      out.write("\t$.get(\"Books\", function(data, status){\n");
      out.write("\t\tif(data){\n");
      out.write("            var len = data.length;\n");
      out.write("            var txt = \"\";\n");
      out.write("            if(len > 0){\n");
      out.write("                for(var i=0;i<len;i++){\n");
      out.write("                        txt += \"<tr><td>\"+data[i].id+\"</td><td>\"+data[i].name+\"</td><td>\"+data[i].author_name+\"</td><td>\"+data[i].year+\"</td></tr>\";\n");
      out.write("                   }\n");
      out.write("                if(txt != \"\"){\n");
