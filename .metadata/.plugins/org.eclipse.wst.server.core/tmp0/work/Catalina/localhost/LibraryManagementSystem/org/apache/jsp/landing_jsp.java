 ...
 * Generated at: 2017-04-07 18:07:22 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t<td><input align=\"left\" type=\"checkbox\" name=\"librarian\" onclick='window.location.assign(\"Librarian.jsp\")'value=\"librarian\" id=\"librarian\"><label for=\"librarian\"> Librarian</label></td>\n");
      out.write("\t\t\t\t\t\t\t<td><input align=\"right\" type=\"checkbox\" name=\"user\" onclick='window.location.assign(\"Books.jsp\")' value=\"user\" id=\"user\"><label for=\"user\"> User</label></td>\n");
